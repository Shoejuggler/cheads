function check() {
   ...
   if (question1 == "b") {
        ...
        correct1.innerHTML = '&#10004Correct! Nice reading comprehension!';
        correct1.style.backgroundColor = '#41ad49';
    }else {
        
        incorrect1.innerHTML = "&#10008No. Try taking a look a the title of this --quiz-- again..."
    ...
    if (question2 == "Mississippi backwards") {
      ...
      correct2.innerHTML = "&#10004Correct! I thought I had you there.";
        ...
        incorrect2.innerHTML = "&#10008Nope. It's spelled M-i-s-s-i-s-s-i-p-p-i b-a-c-k-w-a-r-d-s"
    ...
    correct3.innerHTML = "&#10004Yep! I like these characters and a whole lot more!";
        ...
        incorrect3.innerHTML = "&#10008Negative. Try picking a more --inclusive-- answer."
    ...
    correct4.innerHTML = "&#10004Hey! How did you know?";
        ...
        incorrect4.innerHTML = "&#10008NopeSorry. I'm actually much more partial to orange."
    ...
    if (question5 == "a") {
        ...
        correct5.innerHTML = "&#10004Right! I'm really looking forward to my brother's Monkey Bread";
        ...
        incorrect5.innerHTML = "&#10008NopeNada. I am eating at 5:00 this year"
    ...
    correct6.innerHTML = "&#10004Are you psychic or something?";
        ...
        incorrect6.innerHTML = "&#10008NopeMy fingers are busy typing out this code, so I am not actually holding any fingers."
